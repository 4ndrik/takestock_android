...
class ExpiredAdvertsAdapter extends BaseAdvertsAdapter {

    private static final @LayoutRes int ITEM_LAYOUT_RESOURCE = R.layout.item_advert_selling_expired;

    ExpiredAdvertsAdapter(Context context) {
