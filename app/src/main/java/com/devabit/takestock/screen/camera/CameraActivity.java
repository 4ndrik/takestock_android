package com.devabit.takestock.screen.camera;
...
import com.devabit.takestock.widget.AutoFitTextureView;
...
public class CameraActivity extends AppCompatActivity {
    ...
    @BindView(R.id.texture_view) protected AutoFitTextureView mTextureView;
    ...
    private File getPhotoFile() {
        ...
        LOGD(TAG, "mediaStorageDir exists: " + mediaStorageDir.exists());
        return new File(
                publicPictureDirection.getPath() + File.separator
