...
public class CircleImageView extends ImageView {
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mEditIconDrawable = a.getDrawable(R.styleable.CircleImageView_civ_edit_icon);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mEditIconDrawable != null) {
            mEditIconDrawable.setBounds(
                    canvas.getWidth() - canvas.getWidth() / 4, canvas.getHeight() - canvas.getHeight() / 4,
                    canvas.getWidth(), canvas.getHeight());
            mEditIconDrawable.draw(canvas);
        }
    }
