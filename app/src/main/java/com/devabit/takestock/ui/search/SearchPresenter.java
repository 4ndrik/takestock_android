...
public class SearchPresenter implements SearchContract.Presenter {
    ...
    public SearchPresenter(@NonNull DataRepository dataRepository, @NonNull SearchContract.View sellingView) {
        mDataRepository = checkNotNull(dataRepository, "dataRepository cannot be null.");
        mSearchView = checkNotNull(sellingView, "sellingView cannot be null.");
    ...
    @Override public void fetchAdverts() {
        ...
        Subscription subscription = mDataRepository
                .getAdverts()
                .compose(RxTransformers.<List<Advert>>applyObservableSchedulers())
                .subscribe(new Subscriber<List<Advert>>() {
                    ...
                    @Override public void onNext(List<Advert> adverts) {
                        mSearchView.showAdvertsInView(adverts);
                    }
                });
