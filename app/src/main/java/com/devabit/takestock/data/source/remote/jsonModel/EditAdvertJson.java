...
public class EditAdvertJson implements JsonModel {
    ...
    public final boolean is_vat_exempt;
    public final int state;

    public EditAdvertJson(Advert advert) throws IOException {
    ...
    private String[] toPhotoList(List<Photo> photos) throws IOException {
        ...
        for (int i = 0; i < photos.size(); i++) {
            ...
            result[i] = photo.getImagePath().startsWith("http")
                    ? "data:image/jpg;base64," + Encoder.encodeUrlToBase64(photo.getImagePath())
                    : "data:image/jpg;base64," + Encoder.encodeFileToBase64(photo.getImagePath());
        }
        return result;
    }
}
