 ...
 */
public class PackagingJsonDeserializer implements JsonDeserializer<List<Packaging>> {
    @Override public List<Packaging> deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context)
