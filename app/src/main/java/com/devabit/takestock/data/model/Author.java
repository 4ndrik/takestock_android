...
public class Author implements Parcelable {
    ...
    public boolean mHasNotifications;
...
//            "business_sub_type": null
    ...
    Author(int id, String userName, String firstName, String lastName, String businessTypeName,
           ...
           String postcode, String vatNumber, boolean hasNotifications) {
        mId = id;
        mUserName = userName;
    ...
    public static class Builder {
        ...
        public Author build() {
            return new Author(mId, mUserName, mFirstName, mLastName, mBusinessTypeName, mBusinessSubtypeName,
                    ...
                    mPhoto, mBusinessName, mPostcode, mVatNumber, mHasNotifications);
        }
    }
}
