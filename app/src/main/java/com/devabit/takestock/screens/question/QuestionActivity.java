...
import com.devabit.takestock.screens.question.adapters.QuestionsAdapter;
...
public class QuestionActivity extends AppCompatActivity implements QuestionContract.View {
    ...
    private static final String TAG = makeLogTag(QuestionActivity.class);
    ...
    private void initPresenter() {
        new QuestionPresenter(
                Injection.provideDataRepository(QuestionActivity.this), QuestionActivity.this);
    }

    private void setUpToolbar() {
        final Typeface boldTypeface = FontCache.getTypeface(this, R.string.font_brandon_bold);
        Toolbar toolbar = ButterKnife.findById(QuestionActivity.this, R.id.toolbar);
    ...
    private void setUpQuestionRecyclerView() {
        RecyclerView recyclerView = ButterKnife.findById(QuestionActivity.this, R.id.recycler_view);
        LinearLayoutManager layoutManager = new LinearLayoutManager(
                QuestionActivity.this, LinearLayoutManager.VERTICAL, false);
        recyclerView.setLayoutManager(layoutManager);
        mQuestionsAdapter = new QuestionsAdapter(QuestionActivity.this);
    ...
    private int getUserId() {
        AccountManager accountManager = AccountManager.get(QuestionActivity.this);
